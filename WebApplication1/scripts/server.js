...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['inboxHub'] = this.createHubProxy('inboxHub'); 
        proxies['inboxHub'].client = { };
        proxies['inboxHub'].server = {
        };
        ...
        proxies['notificationHub'].server = {
            ...
            /// <summary>Calls the GetNotificationCount method on the server-side NotificationHub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
