...
namespace XYZ.APIs
{
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IAppointmentsBusinessManager>().To<AppointmentsBusinessManager<AppointmentsRepository>>().InRequestScope();
            kernel.Bind<IEmployeeAppointmentsBusinessManager>().To<EmployeeAppointmentsBusinessManager<EmployeeAppointmentsRepository>>().InRequestScope();
            kernel.Bind<IEmployeesBusinessManager>().To<EmployeesBusinessManager<EmployeesRepository>>().InRequestScope();
